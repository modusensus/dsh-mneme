...
- **Vector search**: OpenAI-compatible embeddings API for semantic matching of differently-worded but related memories, plus fully-offline local backends (v0.2+)
